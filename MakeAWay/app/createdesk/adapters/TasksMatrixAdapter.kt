...
class TasksMatrixAdapter(
    private val onClick: ((TaskMatrix) -> Unit)? = null
) : RecyclerView.Adapter<TasksMatrixAdapter.ProjectsViewHolder>() {

    var data: List<TaskMatrix> = listOf()
        set(value) {
            field = value
...
//            return "Срок истек"
//        }
//        val sdf = SimpleDateFormat("dd MMM", Locale.getDefault())ц
